...
browserObj.then(function (browser) {
    ...
    .then(function () {
        let clickonSelectorPromise = page.click('.cfxYMc.JfZTW.c4Djg.MUxGbd.v0nnCb', { delay: 100 });
    ...
    .then(function () {
        let enterwillbetypedPromise = page.keyboard.press("Enter", { delay: 100 });
